 ...
 */
package trainingproject.it.launcher;
...
/** Test server-side aaaaa using the Sling JUnit servlet, as opposed
...
public class SlingServerSideTestsBase extends SlingTestBase {
    ...
    /** Before running aaaaa, setup a node that gives access to the Sling JUnit servlet,
    ...
    public SlingServerSideTestsBase() {
        ...
        if(servletCheckFailed) {
            fail(SLING_JUNIT_SERVLET_PATH + " check failed previously, cannot run aaaaa");
        }
